...
public class Automata {
     ...
     * Transition table
     * - A MultiKeyMap with:
     * "source state" as first key;
     * "transition character" as second key;
     * "reachable states" list of {@code List<String>} as values;
     * 
     */
     ...
     */
    public void addTransition(String sourceState, Character transitionCharacter, String targetState) throws InvalidStateException, DuplicatedTransitionException {
	if (transitions == null)
	    throw new IllegalStateException();
    ...
    /**
     * Returns reachable states list of type {@code List<String>} given a source state and a transition character
     * <br> returns <b>{@code null}</b> if transition does not exist
     * 
     * @param sourceState - transition source state
     * @param transitionCharacter - transition character
     * @throws InvalidStateException When refers to states not present in automata
     ...
     * @throws DuplicatedTransitionException
     */
    public void complete(String dead) throws DuplicatedStateException, InvalidStateException, DuplicatedTransitionException {
